...
public class WorkspaceControllerImpl implements WorkspaceController {
    ...
    @Override
    @PostMapping( value = "api/workspace")
    public ResponseEntity<WorkspaceDTO> create(@RequestBody WorkspaceEntity entity) throws SQLException, NoSuchWorkspaceException {
        workspaceService.create(entity);
        var link = linkTo(methodOn(WorkspaceControllerImpl.class).find(entity.getId())).withSelfRel();
        var workspaceDTO = new WorkspaceDTO(entity, link);
    ...
    public ResponseEntity<WorkspaceDTO> update(@PathVariable Integer id, @RequestBody WorkspaceEntity workspace) throws SQLException, NoSuchWorkspaceException {
    ...
    public ResponseEntity delete(@PathVariable Integer id) throws SQLException, NoSuchWorkspaceException, ExistsWorkspaceForWorkspaceException {
    ...
    public ResponseEntity<List<WorkspaceDTO>> getWorkspaceByDesktop(@PathVariable Integer id) throws SQLException, NoSuchWorkspaceException {
        var workspace = workspaceService.getWorkspaceByDesktopId(id);
    ...
    @GetMapping(value = "api/workspace/monitors/{id}")
